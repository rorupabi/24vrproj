  ...
  return (
    <div className='relative mt-10 min-[800px]'>
      <div className="text-center">
        <span className='text-blue-500 h-6 text-lg font-medium px-2 py-1 uppercase'>
          features
        </span>
      ...
      <div className='flex flex-wrap mt-10 lg:mt-20'>
        {features.map((feature, index) => (
          <div key={index} className='w-full sm:1/2 lg:w-1/3'>
            <div className='flex'>
              <div className='flex mx-6 h-10 w-10 p-2 text-blue-500 justify-center items-center rounded-full'>
                {feature.icon}
              </div>
              <div>
