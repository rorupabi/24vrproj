      ...
      <div className="flex flex-wrap justify-center">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 py-2">
            ...
            <div className="bg-neutral rounded-md p-6 text-md border border-neutral-800 font-thin flex flex-col justify-between h-full transform hover:scale-105 duration-200 ease-in-out">
              ...
              <div className="flex flex-col items-start text-center mt-8">
                {/* User Profile Image */}
                <img
                  className="w-12 h-12 rounded-full border border-neutral-300 hover:"
